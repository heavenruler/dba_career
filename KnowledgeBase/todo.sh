...
# Generated: 2026-05-22 08:39
#
# Inventory (snapshot at generation):
#   Total extracted docs : 897
#   Already filtered     : 1  (auto-skipped)
#   Pending              : 896
#   Total char (trunc to 60000): 10,991,540
#   Est. tokens          : ~13.7M
...
#
# Generated by Claude. Re-generate after adding new PDFs:
#   ./scripts/regen_todo.sh  (if exists)  or  re-run the embedded python in this header.
...
DOCS=(
  ...
  # === window 9/9 (801-896, avg 2384 chars/doc) ===
  ...
  6c2de22321bbf4314340079d32987347  #    216c  mp.weixin.qq.com          一张图了解常用Hint
)
