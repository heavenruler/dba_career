...
> 最後驗證：2026-07-11｜3 年 TCO 僅提供建模框架；所有金額、折扣、用量與匯率均 TBD，不得以 PoC 推估報價。
...
`3 年 TCO = 一次性成本 + Σ(年度平台 + 年度軟體/支援 + 年度人力 + 年度網路/儲存 + 風險準備)`
...
- [決策] 既有計畫將 TCO 列為後續調查，非已完成工作；本文件不引入任何價格。計算窗口已於 2026-08-19 由 5 年調整為 3 年（見 [D-07](./appendices/decision-log.md)），原會議記錄的 5 年敘述為當時口徑。[2026-06-16 會議](../1_MeetingMinutes/0616.md)
