...
#### **一、 網路延遲情境下的效能差異 (RTT 200 ms)**

TiDB、PD Leader、TiKV 之間逐層注入額外延遲觀察。

| 元件 | 測試條件 | 併發數 (Concurrency) | 基準 QPS (Default) | 200 ms 延遲 QPS | QPS 下降幅度 (約) | 平均回應時間 (avg_ms/req) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **TiProxy** | Latency | 1000 | 41631.97 [3] | **2608.58** [4] | 93.7% | 0.38 [4] |
| **TiDB** | Latency | 1000 | 38870.17 [5] | 5217.21 [6] | 86.6% | 0.19 [6] |
| **PD Leader** | Latency | 1000 | 38709.68 [7] | 19373.59 [8] | 50.0% | 0.05 [8] |
| **TiKV Write** | Latency | 1000 | 7874.02 [9] | 3024.19 [10] | 61.6% | 0.33 [10] |
| **TiKV Read** | Latency | 1000 | 8086.25 [11] | 8645.53 [12] | *上升* | 0.12 [12] |
