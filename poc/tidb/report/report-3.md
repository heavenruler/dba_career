...
1.  **TiProxy 和 TiDB 敏感度最高：** 在 200 ms RTT 延遲下，**TiProxy** 的 QPS 表現為所有元件中下降比例最大的，可能導致 **Tiproxy 連線異常告警**。
2.  **TiKV Read 表現堅韌：** TiKV 的讀取效能 (Read QPS) 在 200 ms 延遲下，與基準值相比仍維持穩定。
3.  **PD Leader 容忍度居中：** PD Leader 的 QPS 下降幅度約為 50%，相對 TiProxy 和 TiDB 而言，對延遲的容忍度更高。

| 元件 | 測試條件 | 併發數 (Concurrency) | 基準 QPS (Default) | 200 ms 延遲 QPS | QPS 下降幅度 (約) | 平均回應時間 (avg_ms/req) |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **TiProxy** | Latency | 1000 | 41631.97 [3] | **2608.58** [4] | 93.7% | 0.38 |
| **TiDB** | Latency | 1000 | 38870.17 [5] | 5217.21 [6] | 86.6% | 0.19 |
| **PD Leader** | Latency | 1000 | 38709.68 [7] | 19373.59 [8] | 50.0% | 0.05 |
| **TiKV Write** | Latency | 1000 | 7874.02 [9] | 3024.19 [10] | 61.6% | 0.33 |
| **TiKV Read** | Latency | 1000 | 8086.25 [11] | 8645.53 [12] | *上升* | 0.12 |
