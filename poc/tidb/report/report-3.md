...
- TiKV
  - Write
    - Latency ~= Default @ mysqlslap_logs_20251124_134419
      | concurrency | avg(s) | min(s) | max(s) | avg_qps | avg_ms/req |
      |--------------|--------|--------|--------|----------|-------------|
      | 10 | 1.98 | 1.85 | 2.07 | 5050.51 | 0.20 |
      | 50 | 0.62 | 0.60 | 0.65 | 16068.56 | 0.06 |
      | 100 | 0.41 | 0.39 | 0.43 | 24271.84 | 0.04 |
      | 250 | 0.34 | 0.32 | 0.36 | 28985.51 | 0.03 |
      | 500 | 0.35 | 0.34 | 0.36 | 28544.24 | 0.04 |
      | 1000 | 0.40 | 0.38 | 0.42 | 24691.36 | 0.04 |
    - Latency ~= 50 ms @ 
