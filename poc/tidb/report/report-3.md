...
- TiKV
  - Write
    - Latency ~= Default @ mysqlslap_logs_20251124_132957
      | concurrency | avg(s) | min(s) | max(s) | avg_qps | avg_ms/req |
      |--------------|--------|--------|--------|----------|-------------|
      | 10 | 1.03 | 1.03 | 1.03 | 97244.73 | 0.01 |
      | 50 | 1.06 | 1.05 | 1.07 | 94339.62 | 0.01 |
      | 100 | 1.07 | 1.06 | 1.08 | 93370.68 | 0.01 |
      | 250 | 1.10 | 1.10 | 1.11 | 90525.05 | 0.01 |
      | 500 | 1.28 | 1.19 | 1.43 | 78288.10 | 0.01 |
      | 1000 | 2.87 | 2.86 | 2.88 | 34843.21 | 0.03 |
    - Latency ~= 50 ms @ mysqlslap_logs_20251124_133111
      | concurrency | avg(s) | min(s) | max(s) | avg_qps | avg_ms/req |
      |--------------|--------|--------|--------|----------|-------------|
      | 10 | 1.04 | 1.03 | 1.05 | 96184.67 | 0.01 |
      | 50 | 1.04 | 1.04 | 1.05 | 96092.25 | 0.01 |
      | 100 | 1.06 | 1.05 | 1.07 | 94369.30 | 0.01 |
      | 250 | 1.09 | 1.08 | 1.10 | 91575.09 | 0.01 |
      | 500 | 1.33 | 1.17 | 1.54 | 75206.82 | 0.01 |
      | 1000 | 2.64 | 2.52 | 2.71 | 37821.48 | 0.03 |
    - Latency ~= 100 ms @ 
  ...
  - Read
    - Latency ~= Default @ mysqlslap_logs_20251124_131952
      | concurrency | avg(s) | min(s) | max(s) | avg_qps | avg_ms/req |
      |--------------|--------|--------|--------|----------|-------------|
      | 10 | 1.03 | 1.02 | 1.03 | 97402.60 | 0.01 |
      | 50 | 1.04 | 1.03 | 1.04 | 96587.25 | 0.01 |
      | 100 | 1.06 | 1.05 | 1.06 | 94637.22 | 0.01 |
      | 250 | 1.10 | 1.10 | 1.11 | 90771.56 | 0.01 |
      | 500 | 1.31 | 1.16 | 1.58 | 76142.13 | 0.01 |
      | 1000 | 2.72 | 2.66 | 2.77 | 36724.20 | 0.03 |
    - Latency ~= 50 ms @ mysqlslap_logs_20251124_132141
      | concurrency | avg(s) | min(s) | max(s) | avg_qps | avg_ms/req |
      |--------------|--------|--------|--------|----------|-------------|
      | 10 | 1.03 | 1.02 | 1.03 | 97434.23 | 0.01 |
      | 50 | 1.04 | 1.03 | 1.04 | 96277.28 | 0.01 |
      | 100 | 1.06 | 1.06 | 1.06 | 94577.55 | 0.01 |
      | 250 | 1.09 | 1.08 | 1.09 | 92109.30 | 0.01 |
      | 500 | 1.35 | 1.14 | 1.62 | 73982.74 | 0.01 |
      | 1000 | 2.56 | 2.43 | 2.73 | 39082.86 | 0.03 |
    - Latency ~= 100 ms @ mysqlslap_logs_20251124_132243
      | concurrency | avg(s) | min(s) | max(s) | avg_qps | avg_ms/req |
      |--------------|--------|--------|--------|----------|-------------|
      | 10 | 1.04 | 1.03 | 1.04 | 96401.03 | 0.01 |
      | 50 | 1.06 | 1.04 | 1.08 | 94339.62 | 0.01 |
      | 100 | 1.08 | 1.05 | 1.12 | 92994.42 | 0.01 |
      | 250 | 1.12 | 1.09 | 1.18 | 88994.36 | 0.01 |
      | 500 | 1.18 | 1.16 | 1.20 | 84889.64 | 0.01 |
      | 1000 | 2.71 | 2.64 | 2.78 | 36909.45 | 0.03 |
    - Latency ~= 200 ms @ mysqlslap_logs_20251124_132339
      | concurrency | avg(s) | min(s) | max(s) | avg_qps | avg_ms/req |
      |--------------|--------|--------|--------|----------|-------------|
      | 10 | 1.06 | 1.05 | 1.06 | 94577.55 | 0.01 |
      | 50 | 1.08 | 1.08 | 1.08 | 92564.02 | 0.01 |
      | 100 | 1.14 | 1.12 | 1.16 | 87591.24 | 0.01 |
      | 250 | 1.26 | 1.22 | 1.30 | 79660.12 | 0.01 |
      | 500 | 1.53 | 1.38 | 1.71 | 65288.36 | 0.02 |
      | 1000 | 2.01 | 1.60 | 2.56 | 49693.56 | 0.02 |
