...
|------|---------------|----------------|--------|
| read_only | 12,536 → 13,282 QPS | **+6%** |
| points | 5,097 → 5,538 QPS | **+8.6%** |
| ranges | 5,598 → 7,027 QPS | **+25.5%** |
...
| 類型 | 單 SQL 多 KV | 多 SQL 單 KV | 差異 |
|------|---------------|----------------|--------|
| update_index | 3,371 → 3,946 TPS | **+17.1%** |
| write_only | 1,500 → 1,782 TPS | **+18.8%** |
...
| 類型 | 單 SQL 多 KV | 多 SQL 單 KV | 差異 |
|------|---------------|----------------|--------|
| read_write | 10,078 → 11,229 QPS | **+11.4%** |
