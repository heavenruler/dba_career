...
Outputs:
  ...
  (optional) sysbench_results_#2_tidb_summary.svg

Usage:
  python sysbench_results_#2_tidb.py            # generate PNG
  python sysbench_results_#2_tidb.py --show     # print table then generate
  python sysbench_results_#2_tidb.py --svg      # also export SVG
"""
...
SVG_NAME = "sysbench_results_#2_tidb_summary.svg"
...
def main():
    ap = argparse.ArgumentParser(description='Plot sysbench scenario #2 (TiDB) line charts.')
