# A7(1)(4) 補強驗證結果（smoke 規模 W=4，TS=20260722T101909+0800）
...
**FAIL**（詳見 verify-a7-20260722T101909+0800-ybdb-realtxn.log）
### A7(4) t128 執行期間採樣（每 12s 一次，共 330s）
PASS=14 FAIL=1（詳見 verify-a7-20260722T101909+0800-ybdb-underload.log / .detail）
