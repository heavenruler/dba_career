...
| 專案第 5 週 | 2026-06-03 ~ 2026-06-09 | 🟡 | 跨專線的分散式資料庫測試項目：初版範圍已定，A/A、A/A(Read Only)、A/S、備份架構與資料遷移策略待補齊 | - |
| 專案第 6 週 | 2026-06-10 ~ 2026-06-16 | ⚪ | 彙整建置 / 維運 / 擴展成本，整理最低成本啟動路徑與前置條件 | - |
| 專案第 7 週 | 2026-06-17 ~ 2026-06-23 | ⚪ | 完成三份報告的整合版、補足缺口與簽核材料 | - |
