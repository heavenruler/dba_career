...
| TiDB | HAProxy - 3s3r（PD `l4r4`） | READ COMMITTED | [20260601T003316](./tidb-tc1/S-BASE/vm-3node-haproxy-3s3r-rc-pd-sched-l4r4/tidb-vm-3node-haproxy-3s3r-rc-20260601T003316+0800/) | t=128 | **26,947** | 309 | 0.000% | [流程紀錄](./tidb-tc1/S-BASE/pipeline-log.md#vm-3node-haproxy-3s3r-rc)；[HAProxy vs direct 分析](./dispatch-records/2026-06-01-tidb-haproxy-vs-direct-3s3r-l4r4.md)；N=1，3 tidb_servers + HAProxy round-robin，vs direct l4r4 +78.7% |
...
| 專案第 3-4 週 | 2026-05-20 ~ 2026-06-02 | 🟡 | 推進 vm-3node direct / HAProxy，補齊 shard / replica / triple gate 說明，整理 dispatch analysis，並收斂三節點與 Kubernetes 的待重跑項 | - |
| 專案第 5-6 週 | 2026-06-03 ~ 2026-06-16 | 🟡 | 跨專線的分散式資料庫測試項目：初版範圍已定，A/A、A/A(Read Only)、A/S、備份架構與資料遷移策略待補齊；同時彙整建置 / 維運 / 擴展成本與最低成本啟動路徑 | - |
