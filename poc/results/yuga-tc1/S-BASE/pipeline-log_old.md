...
> ⚠️ **[廢棄參考]** 本檔案 VM 相關測試數據均基於 **YugabyteDB 2.20 版本** 且 isolation 為**預設 snapshot** 設定下所測得，版本已廢棄，僅供歷史對照參考用。
...
- **tpmC 天花板**：併發從 16 增加到 128，tpmC 僅從 414.7 降至 370.4（-10.7%）。多開 thread 沒有帶來更多吞吐，表示 DB 已無法再併發處理更多工作。
