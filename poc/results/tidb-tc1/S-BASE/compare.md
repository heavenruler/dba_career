...
1. **VM peak 在 64t 後反降**（20,816 → 18,923），k8s-unlimit 未出現此現象
   → [根因已確認：AUTO ANALYZE + co-location](#vm-128t-反降根因分析)
...
| threads | vm | k8s-unlimit | Δ unlimit | k8s-limit | Δ limit |
|---------|----|-------------|-----------|-----------|---------|
| 16  | 56.6  | 56.6  | +0.0   | 96.5  | **+39.9** |
| 32  | 92.3  | 104.9 | +12.6  | 201.3 | **+109.0** |
| 64  | 176.2 | 218.1 | +41.9  | 352.3 | **+176.1** |
| 128 | 419.4 | 436.2 | +16.8  | 704.6 | **+285.2** |

#### PAYMENT p99 (ms)

| threads | vm | k8s-unlimit | Δ unlimit | k8s-limit | Δ limit |
|---------|----|-------------|-----------|-----------|---------|
| 16  | 37.7  | 37.7  | +0.0   | 65.0  | **+27.3** |
| 32  | 71.3  | 75.5  | +4.2   | 134.2 | **+62.9** |
| 64  | 142.6 | 176.2 | +33.6  | 268.4 | **+125.8** |
| 128 | 369.1 | 385.9 | +16.8  | 637.5 | **+268.4** |
